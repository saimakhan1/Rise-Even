...
//   // Diagonal Black Arrow SVG Component
//   const BlackArrow = () => (
//     <svg
//       width="14"
//       height="14"
...
//   return (
//     <section className="bg-[#f2f1ef] py-20 px-8 font-sans">
//       {/* Header Section */}
//       <div className="flex justify-between items-end border-b border-gray-200 pb-10 mb-2">
//         <h1 className="text-8xl font-medium tracking-tight flex items-center gap-4">
//           Our
//           <span className="inline-block w-30 h-30 rounded-xl overflow-hidden">
//             <img
//               src={MyImage}
//               alt="My Profile"
...
//         {/* --- WHITE BUTTON WITH TEXT SLIDE & MORPH --- */}
//         <button className="group relative h-12 w-52 overflow-hidden bg-white text-black transition-all duration-500 ease-in-out rounded-[40px] hover:rounded-xl shadow-sm border border-gray-100">
...
//             className="relative group cursor-pointer border-b border-gray-200 py-10 overflow-hidden transition-all duration-300"
//           >
//             {/* Hover Background Image Layer */}
//             <div
//               className={`absolute inset-0 z-0 transition-all duration-500 ease-out rounded-full scale-[0.98] opacity-0 group-hover:opacity-100 group-hover:scale-100 mx-2 my-1`}
//               style={{
...
//               {/* LARGE CUSTOM ARROW */}
//               <div className="w-0 opacity-0 -ml-4 transition-all duration-500 ease-in-out group-hover:w-12 group-hover:opacity-100 group-hover:mr-4 group-hover:ml-0 flex items-center justify-center">
//                 <svg
//                   viewBox="0 0 24 24"
//                   fill="none"
