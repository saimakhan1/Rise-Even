      ...
      <div className="md:sticky md:top-0 md:h-screen w-full flex flex-col items-center justify-center p-4 lg:p-8">
        ...
        <div className="relative w-full bg-black rounded-[25px] overflow-hidden flex flex-col md:flex-row h-auto md:h-full">
          ...
          <div className="flex flex-col gap-6 px-4 pb-12 md:hidden">
            {WORKS.map((work) => (
              <div key={`mob-${work.id}`} className="relative w-full group">
        ...
        {/* BUTTON: Outside Black Box on ALL devices */}
        <div className="mt-8 md:mt-10">
          <motion.button
            initial="initial"
            whileHover="hover"
            className="group relative flex items-center justify-center bg-white text-black text-[15px] md:text-[16px] font-bold px-10 py-4 overflow-hidden shadow-md"
            variants={{
              initial: { borderRadius: "100px" },
              hover: { borderRadius: "12px" },
            }}
