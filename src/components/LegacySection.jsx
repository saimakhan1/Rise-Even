...
//   // Mobile Scroll Logic for the indicator
...
//     >
//       {/* MOBILE VERSION */}
//       <div className="md:hidden w-full pt-10 pb-20">
...
//               {/* Text Content - Left Aligned to match reference */}
...
//                   <p className="text-[15px] font-medium  px-2">
//                     {card.mission || card.extra}
//                   </p>
//                 )}
//               </div>
...
//         {/* PERSISTENT INDICATOR: Dark black line at bottom */}
//         {/* <div className="px-10 mt-10">
//           <div className="relative w-full h-[3px] bg-black rounded-full overflow-hidden">
//             <motion.div
